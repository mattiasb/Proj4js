...
Proj4js.Proj = Proj4js.Class({
  ...
  */
  initialize: function(srsCode, proj4) {
	  ...
	  //TODO: Take a cup of coffee and think about these srsCodes and what they actually provide
    ...
    loadProjCode: function(projName) {
      if (Proj4js.Proj[projName]) {
        ...
        return;
		  ...
		  // TODO: handle error where projcode doesn't exist
	  }
    },
...
Proj4js.WGS84 = new Proj4js.Proj('WGS84', "+title=long/lat:WGS84 +proj=longlat +ellps=WGS84 +datum=WGS84 +units=degrees");
